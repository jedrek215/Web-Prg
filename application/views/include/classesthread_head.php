...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('bootstrap/css/page.css')?>">
    <link rel="stylesheet" href="<?php echo base_url('bootstrap/css/modal.css')?>">
